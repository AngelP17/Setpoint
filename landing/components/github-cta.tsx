          ...
          <div className="md:col-span-5">
            <div className="flex flex-col items-start gap-3 md:items-end">
              <a
                ...
                className="group inline-flex items-center gap-3 rounded-pill bg-arc-500 px-6 py-3 text-sm font-medium text-ink-950 transition hover:-translate-y-px hover:shadow-[0_0_20px_rgba(0,212,255,0.4)] active:scale-[0.98] active:translate-y-0 duration-200 ease-out glow-arc"
              >
