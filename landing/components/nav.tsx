  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-ink-700/40 bg-ink-950/70 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between px-6">
        <Link href="/" className="flex items-center gap-2.5 font-mono text-sm tracking-tight transition hover:opacity-90 active:scale-[0.98] duration-200">
        ...
        <nav className="hidden items-center gap-7 text-sm text-ink-300 md:flex">
          <a href="#proof" className="transition hover:text-ink-50 active:scale-[0.98] duration-150">Proof</a>
          <a href="#how" className="transition hover:text-ink-50 active:scale-[0.98] duration-150">How it works</a>
          <a href="#spec" className="transition hover:text-ink-50 active:scale-[0.98] duration-150">Spec</a>
        </nav>
        <div className="flex items-center gap-3">
          <ThemeToggle />
          <a
            href="https://github.com/apinzon/setpoint-operator"
            className="group inline-flex items-center gap-2 rounded-pill border border-ink-600 bg-ink-800/50 px-3.5 py-1.5 font-mono text-xs text-ink-200 transition hover:border-arc-500/50 hover:text-ink-50 active:scale-[0.98] duration-200"
          >
